...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/speech_pipeline.launch.py']),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'speaker_test = speech_processor.speaker_test:main',
            ...
            'wake_audio_processor = speech_processor.wake_audio_processor:main',
